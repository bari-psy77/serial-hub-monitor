...
- **테스트 실측(2026-09-03)**: `python selftest.py` → **286 passed**, `python selftest.py --gui` → **419 passed**, `python uitest.py` → **179 passed**. 합계 598건 전부 통과(`--gui` 는 core 를 포함하므로 419+179 로 센다). `ruff check . --select E,F,W,B,ARG --line-length 110` 클린.
