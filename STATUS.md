...
- **테스트 실측(2026-09-01)**: `python selftest.py` → **237 passed**, `python selftest.py --gui` → **324 passed**, `python uitest.py` → **166 passed**. 합계 727건 전부 통과. `ruff check . --select E,F,W,B,ARG --line-length 110` 클린.
